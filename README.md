This is a simple two-page web project built during the [udemy clone] on Udemy. It includes a responsive layout and modern UI practices using [your tech stack].
